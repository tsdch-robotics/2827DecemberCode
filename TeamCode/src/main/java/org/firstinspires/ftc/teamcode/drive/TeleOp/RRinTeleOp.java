...
public class RRinTeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
       ...
       // drive.setPoseEstimate(PoseStorage.currentPose);
        ...
        Pose2d startPose = new Pose2d(-50, 0, Math.toRadians(-90));
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch (currentMode) {
                ...
                case AUTOMATIC_CONTROL:
                    ...
                    if (gamepad1.x){//sensors are too close) {
                        drive.cancelFollowing();//cancels the following
